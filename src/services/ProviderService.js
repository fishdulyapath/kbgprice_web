...
const instanceApi = (authentication = true) =>{
    ...
    //http://43.240.113.43:8776/KBGPriceServiceAPI/service/stockservice/
    const http = axios.create({ baseURL: 'http://localhost:8084/KBGPriceServiceAPI/service/priceservice/'});
